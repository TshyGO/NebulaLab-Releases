...
[**📥 下载最新版本**](https://github.com/TshyGO/NebulaGraph-Releases/releases/latest) &nbsp;&nbsp;•&nbsp;&nbsp; [**📄 查看发版记录**](https://github.com/TshyGO/NebulaGraph-Releases/releases)
...
> **Nebula Graph 的定位：** 为组级数据（Group-level Data）和多谱图序列提供稳定、可重复的预处理流程，减少实验数据在进入 Origin 或其他绘图工具前的重复手工整理。
...
1. 从 [Releases 页面](https://github.com/TshyGO/NebulaGraph-Releases/releases/latest) 下载 `setup.exe` 或 `msi` 安装包。
...
| 安装包 | 适用场景 | 说明 |
| :--- | :--- | :--- |
| `NebulaGraph-*-setup.exe` | 常规桌面安装 | 推荐大多数用户使用，包含标准安装向导与应用更新逻辑。 |
| `NebulaGraph-*.msi` | 统一部署 / 管理环境 | 适合实验室工作站、域控或需要静默分发的场景。 |
